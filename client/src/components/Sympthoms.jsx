            ...
            <div>
              ...
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-gray-700 max-w-3xl mx-auto leading-relaxed">
                  Select one of 3 conditions below to enter your health data and
                  get an instant risk assessment. If risk is detected,
                  specialists will be automatically alerted.
                </p>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        Get instant AI-powered health insights and risk
                        assessments
                      </p>
                    </div>
                  </div>
